  ...
  function createSwitcher() {
    ...
    el.addEventListener("click", function(e) {
      ...
      if (btn.id === "dse-panel-trigger") {
        ...
        if (S.panelRef.style.display === "block") {
          S.panelRef.style.display = "none";
          S.panelVisible = false;
        } else {
          syncPanelMode();
          S.panelRef.style.display = "block";
          S.panelVisible = true;
        }
