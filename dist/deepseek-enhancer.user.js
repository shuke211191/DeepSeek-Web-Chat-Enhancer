...
(function() {
  ...
  function renderPanelContent() {
    ...
    if (S.activePanelTab === "page") {
      ...
      html += colorRow("userBg", "用户气泡背景", "bubble") + colorRow("userText", "用户气泡文字", "bubble") + '<div class="dse-sep"></div>' + colorRow("aiBgL", "AI气泡背景(浅)", "bubble") + colorRow("aiBgD", "AI气泡背景(深)", "bubble") + '<div class="dse-sep"></div>' + colorRow("aiTextL", "AI气泡文字(浅)", "bubble") + colorRow("aiTextD", "AI气泡文字(深)", "bubble");
