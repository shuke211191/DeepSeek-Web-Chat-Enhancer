...
- **代码块折叠** — 在代码块标题栏插入折叠/展开按钮，点击切换代码显示
- **限制代码块高度** — 代码内容最大 60vh，超出原生滚动条滚动
- **中英双语切换** — 界面语言自动/中文/English 三态切换，所有标签即时更新
...
- **稳定选择器**：`.ds-message`、`.ds-markdown`、`.ds-think-content`、`.ds-assistant-message-main-content`、`.ds-virtual-list`、`.md-code-block`、`.md-code-block-banner-wrap`
