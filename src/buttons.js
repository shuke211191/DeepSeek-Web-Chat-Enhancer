...
export function createSwitcher() {
    ...
    el.addEventListener('click', function (e) {
        ...
        if (btn.id === 'dse-panel-trigger') {
            ...
            S.codeBlockHeightValue = 60; GM_setValue(S.K.CODE_BLOCK_HEIGHT_VALUE, 60);
    ...
    var zone = document.createElement('div'); zone.id = 'dse-zone';
    document.body.appendChild(zone);
    zone.addEventListener('mouseenter', function () { if (S.autoHideBtn) el.classList.add('show'); });
    zone.addEventListener('mouseleave', function () { if (S.autoHideBtn) el.classList.remove('show'); });
